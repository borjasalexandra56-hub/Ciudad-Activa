...
import { Bell, MessageCircle, Settings, Search, SlidersHorizontal } from 'lucide-react';
import PullToRefresh from '@/components/PullToRefresh';
import QuickCategoryChips from '@/components/home/QuickCategoryChips';
    ...
    <PullToRefresh onRefresh={load}>
      <div className="w-full max-w-2xl mx-auto lg:max-w-5xl overflow-x-hidden bg-background">
        ...
        <div className="px-4 pt-3 pb-2 space-y-4">
          ...
          {/* 1. Search bar */}
          <Link to="/jobs"
            className="flex items-center gap-2 bg-muted/60 border border-border rounded-xl px-3 py-2.5 active:opacity-70 transition-opacity">
            <Search className="w-4 h-4 text-muted-foreground flex-shrink-0" />
            <span className="flex-1 text-sm text-muted-foreground">Buscar empleos, cursos o eventos...</span>
