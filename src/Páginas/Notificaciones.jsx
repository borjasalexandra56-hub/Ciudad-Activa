...
import { Bell, Briefcase, GraduationCap, CalendarDays, MessageCircle, FileText, Heart, CheckCheck } from 'lucide-react';
          ...
          {notifications.map(notif => {
            ...
            return (
              <Wrapper key={notif.id} {...wrapperProps}
                ...
                {!notif.read && <div className="w-2 h-2 bg-accent rounded-full flex-shrink-0 mt-2" />}
              </Wrapper>
            );
          })}
        </div>
